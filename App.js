...
const HomeScreen = () => {
  return (
    <View style={{ flex: 1 }}>
      ...
      <HomeTabs.Navigator>
        <HomeTabs.Screen
          name="Items To Borrow"
          component={ItemsAvailableScreen}
        />
        <HomeTabs.Screen
          name="Currently Borrowing"
          component={CurrentlyBorrowingScreen}
        />
      </HomeTabs.Navigator>
    </View>
  );
    ...
    <View style={{ flex: 1 }}>
      ...
      <NavigationContainer independent={true}>
        <MyTopTab.Navigator>
          ...
          <MyTopTab.Screen
            name="Currently Taken"
            component={CurrentlyTakenScreen}
          />
        </MyTopTab.Navigator>
      </NavigationContainer>
    </View>
    ...
    <NavigationContainer>
      <Stack.Navigator initialRouteName="OpeningPage">
        <Stack.Screen
          ...
          options={{ title: "Opening Page", headerShown: false }}
        />
        <Stack.Screen
          name="SignUpScreen"
        ...
        />
        <Stack.Screen
          name="AddAnItemToListScreen"
          component={AddAnItemToListScreen}
          options={{ title: "Add Item To Lend" }}
        />
        <Stack.Screen
          name="ItemsAvailableScreen"
          component={ItemsAvailableScreen}
        />
        <Stack.Screen
          name="CurrentlyBorrowingScreen"
          component={CurrentlyBorrowingScreen}
        />
        <Stack.Screen name="AvailableScreen" component={AvailableScreen} />
        <Stack.Screen
          name="CurrentlyTakenScreen"
          component={CurrentlyTakenScreen}
        />
          ...
          options={({ navigation }) => ({
            ...
            headerRight: () => (
              <View style={{ flexDirection: "row" }}>
                <TouchableOpacity
                  onPress={() => navigation.navigate("AddAnItemToListScreen")}
                >
        ...
        />
        <Stack.Screen
          name="ChangePersonalDetailsScreen"
        ...
        />
        <Stack.Screen
          name="ChangePaymentMethodScreen"
        ...
        <Stack.Screen
          ...
          options={{ title: "Borrow Item?" }}
        />
        <Stack.Screen
          name="ReturnItemsScreen"
        ...
        />
        <Stack.Screen
          name="FirstTimePaymentScreen"
          component={FirstTimePaymentScreen}
          options={{ title: "Enter Payment Method" }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
